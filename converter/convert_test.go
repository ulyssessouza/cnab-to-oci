...
func TestConvertFromFixedUpBundleToOCI(t *testing.T) {
	...
	assert.ErrorContains(t, err, "unsupported media type "+
		"\"some-invalid-mediatype\" for image "+
		"\"my.registry/namespace/"+
		"my-app@sha256:d59a1aa7866258751a261bae525a1842c7ff0662d4f34a355d5f36826abc0341\"")

	// All images must be in the same repository
	src = tests.MakeTestBundle()
	src.InvocationImages[0].BaseImage.Image = "my.registry/namespace/" +
		"other-repo@sha256:d59a1aa7866258751a261bae525a1842c7ff0662d4f34a355d5f36826abc0341"
	_, err = ConvertBundleToOCIIndex(src, named, bundleConfigDescriptor)
	assert.ErrorContains(t, err, "invalid invocation image: image "+
		"\"my.registry/namespace/"+
		"other-repo@sha256:d59a1aa7866258751a261bae525a1842c7ff0662d4f34a355d5f36826abc0341\" "+
		"is not in the same repository as \"my.registry/namespace/my-app:0.1.0\"")
